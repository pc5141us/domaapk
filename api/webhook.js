...
module.exports = async (req, res) => {
    ...
    if (callback_query) {
        ...
        if (data.startsWith('del_')) {
            ...
            try {
                await axios.post("https://script.google.com/macros/s/AKfycbyhhYg9TwfLHacwmN9NlMkquYcOZwHWrRL2oFxDp6qLeJ3pJWQJLPzV22qGMIJdYN6Y/exec", {
                    action: "delete_item",
                    id: appId
                });
...
async function sendManageKeyboard(chatId) {
    try {
        const GAS_URL = `https://script.google.com/macros/s/AKfycbyhhYg9TwfLHacwmN9NlMkquYcOZwHWrRL2oFxDp6qLeJ3pJWQJLPzV22qGMIJdYN6Y/exec?t=${Date.now()}`;
